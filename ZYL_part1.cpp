...
void readStep(volatile uint8_t keyArray[7])
{
  ...
  else if (bitRead(keyArray[0], 1) == 0)
  {
    keyNum = 1;
  }
  else if (bitRead(keyArray[0], 2) == 0)
  {
    keyNum = 2;
  }
  else if (bitRead(keyArray[0], 3) == 0)
  {
    keyNum = 3;
  }
  else if (bitRead(keyArray[1], 0) == 0)
  {
    keyNum = 4;
  }
  else if (bitRead(keyArray[1], 1) == 0)
  {
    keyNum = 5;
  }
  else if (bitRead(keyArray[1], 2) == 0)
  {
    keyNum = 6;
  }
  else if (bitRead(keyArray[1], 3) == 0)
  {
    keyNum = 7;
  }
  else if (bitRead(keyArray[2], 0) == 0)
  {
    keyNum = 8;
  }
  else if (bitRead(keyArray[2], 1) == 0)
  {
    keyNum = 9;
  }
  else if (bitRead(keyArray[2], 2) == 0)
  {
    keyNum = 10;
  }
  else if (bitRead(keyArray[2], 3) == 0)
  {
    keyNum = 11;
  }
  else
